...
function ResultCheck() {
  ...
  const getResult = async (values) => {
    try {
      ...
      if (response.data.success) {
        ...
        setMarksheets(response.data.data.marksheets);
      } else {
  ...
  return (
    <div className="layout">
      ...
      <h1>Marksheets</h1>
        <div className="wi" >
          <img width="350px" src={"https://res.cloudinary.com/dvaq2m6aa/image/upload/v1704516142/illg0kyshtxef2vdph0m.jpg"} alt={`Marksheet`} />
        </div>
    </div>
